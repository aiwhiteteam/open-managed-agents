...
| Multiagent threads | Threads share sandbox/filesystem/vault context but keep isolated event streams and context. | Partial; delegated threads are persisted from pinned rosters, execution isolation still TODO |
